...
namespace Acme\ContentBundle\Form\PageParts;

use Acme\ContentBundle\Entity\PageParts\HeaderPagePart;
...
class HeaderPagePartAdminType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => '\Acme\ContentBundle\Entity\PageParts\HeaderPagePart'
        ));
    }
}
