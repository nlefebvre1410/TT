...
namespace Cz\ManagerBundle\Helper\FormWidgets;

use Doctrine\ORM\EntityManager;
use Cz\ManagerBundle\Helper\FormHelper;
use Cz\ManagerBundle\Helper\FormWidgets\Tabs\TabInterface;
...
class FormWidget implements FormWidgetInterface
{
    ...
    public function __construct(array $types = array(), array $data = array(), array $options = array())
    {
        ...
        $this->setTemplate('CzManagerBundle:FormWidgets\FormWidget:widget.html.twig');
    }
