...
use Cz\ManagerBundle\Entity\PageInterface;

/**
 * Configuration for page templates
 *
 * @ORM\Entity(repositoryClass="Cz\PagesPartBundle\Repository\PageTemplateConfigurationRepository")
 * @ORM\Table(name="cz_page_template_configuration", indexes={@ORM\Index(name="idx_page_template_config_search", columns={"page_id", "page_entity_name"})})
 */
