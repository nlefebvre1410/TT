...
namespace Cz\PagePartBundle\Helper\Services;
...
class PagePartCreatorService
{
    ...
    public function setEntityManager(EntityManagerInterface $em)
    {
        ...
        $this->pagePartRepo = $em->getRepository('CzPagePartBundle:PagePartRef');
        $this->translationRepo = $em->getRepository('AcmeContentBundle:Content');
